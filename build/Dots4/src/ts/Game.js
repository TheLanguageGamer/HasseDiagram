...
class Game {
    constructor(container, controller) {
        ...
        window.addEventListener('mouseup', function (e) {
            ...
            _this.mouseUpRecursive(_this.components, e);
        });
        window.addEventListener('mousemove', function (e) {
            ...
            _this.mouseMoveRecursive(_this.components, e);
        });
    ...
    mouseMoveRecursive(components, e) {
        for (var component of components) {
            if (!component.layout.visible) {
                continue;
            }
            if (component.children) {
                if (this.mouseMoveRecursive(component.children, e)) {
                    return true;
                }
            }
            if (component.onMouseMove) {
                if (component.layout.containsPosition(e.offsetX, e.offsetY)) {
                    return component.onMouseMove(e);
                }
    ...
    mouseUpRecursive(components, e) {
        for (var component of components) {
            if (!component.layout.visible) {
                continue;
            }
            if (component.children) {
                if (this.mouseUpRecursive(component.children, e)) {
                    return true;
                }
            }
            if (component.onMouseUp && component.onMouseUp(e)) {
                return true;
            }
        }
        return false;
